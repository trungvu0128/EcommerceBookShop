...
namespace WebApp.Areas.Admin.Controllers
{
    ...
    public class BillsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,DateTime,TotalPrice")] Bill bill)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,DateTime,TotalPrice")] Bill bill)
        {
            if (id != bill.Id)
            {
                return NotFound();
